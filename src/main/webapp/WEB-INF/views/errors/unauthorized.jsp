...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/unauthorized.css">
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">
            You don't have permission to access this page. Please log in with appropriate credentials or contact your
